...
(example "*identifier"
         ...
         (tabulate *identifier ["a" "A" "1" "A1" "a1~" "aba1c2aba"]))
...
(example "Multiple elements preview"
         (defn *array [value]
           (+seqn 1
                  (+char "[")
                  (+opt (+seq value (+star (+seqn 1 (+char ",") value))))
                  (+char "]")))
         (tabulate (*array *number) ["[]" "[1]" "[1,2]" "[1,2,3]" "[1, 2]" "[ 1 , 2 , 3 ]" "[    ]" "[1,2]~" "123" ""]))
(example "Multiple elements"
         (defn *array [value]
           (+seqn 1
                  (+char "[")
                  (+opt (+seqf cons value (+star (+seqn 1 (+char ",") value))))
                  (+char "]")))
         (tabulate (*array *number) ["[]" "[1]" "[1,2]" "[1,2,3]" "[1, 2]" "[ 1 , 2 , 3 ]" "[    ]" "[1,2]~" "123" ""]))
(example "Whitespace handling"
         (defn *array [value]
           (+seqn 1
                  (+char "[")
                  *ws
                  (+opt (+seqf cons value (+star (+seqn 1 *ws (+char ",") *ws value))))
                  *ws
                  (+char "]")))
         (tabulate (*array *number) ["[]" "[1]" "[1,2]" "[1,2,3]" "[1, 2]" "[ 1 , 2 , 3 ]" "[    ]" "[1,2]~" "123" ""]))
